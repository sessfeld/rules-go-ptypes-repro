...
def go_repositories():
    ...
    go_repository(
        ...
        build_directives = [
            "gazelle:resolve go github.com/golang/protobuf/ptypes @com_github_golang_protobuf//ptypes",  # keep
        ...
        sum = "h1:v+X4EwhHl6xE+TG1XgXj4T1XpKKs7ZevcAJ3FOu0YmY=",
        version = "v0.4.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:S34D59DS2GWOEwWNt4fYmTcFrtlOgukG2k9WsomZ7tg=",
        version = "v0.0.0-20221201164419-0e50fba7f41c",
    )
    go_repository(
        name = "org_golang_google_grpc",
        # https://github.com/bazelbuild/bazel-gazelle/issues/1058#issuecomment-939452091
        build_file_proto_mode = "disable",  # keep
    ...
    go_repository(
        ...
        build_extra_args = ["-exclude=**/testdata"],  # keep
